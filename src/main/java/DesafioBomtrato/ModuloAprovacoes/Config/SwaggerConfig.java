package DesafioBomtrato.ModuloAprovacoes.Config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("DesafioBomtrato.ModuloAprovacoes.Controller"))
	...
	public static ApiInfo metadata() {
		...
		.title("Módulo de Aprovação de Processos")
		.description("Desafio Bomtrato - Módulo de Aprovação de Processos")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/SuCastro/ModuloAprovacoesProcessos_DesafioBomtrato")
		.contact(contact())
		.build();
	}
	
	private static Contact contact() {
		return new Contact("Suellen Castro Pires",
		"https://github.com/SuCastro",
		"suellen.cpires@outlook.com");
	}
